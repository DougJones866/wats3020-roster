...
class Person {
    constructor(name, email) {
        this.name = name;
        this.email = email;
        this.username = email.split('@')[0];   //doug@seattleu.edu [doug][seattleu.edu]
    }
}
...
setTeacher() {
    let name = prompt("Enter full teacher name:");
...
//Created prompt for user input//

let courseCode = prompt("Enter the course code");

let courseTitle = prompt("Enter the course title");
